        ...
        {[
          {
            ...
            text: "Recently sold homes similar to yours.",
          },
          {
            icon: LineChart,
            title: "Market Trends",
            text: "Current inventory and pricing conditions.",
          },
          {
            icon: Calculator,
            title: "Estimated Value",
            text: "A realistic value based on today's market.",
          },
          {
            icon: ShieldCheck,
            title: "Protect Your Equity",
            text: "Advice designed to help you maximize your proceeds.",
          },
        ].map((item) => (
        ...
        <Card className="rounded-[2rem] shadow-xl">
          <CardContent className="p-10">
            <h2 className="text-3xl font-bold">
              Request Your Complimentary Home Valuation
            </h2>

            <p className="mt-4 text-muted-foreground">
              Complete the information below and I'll prepare a personalized
            ...
            {submitted && (
              <div className="mt-8 rounded-2xl border border-green-200 bg-green-50 p-6">
                ...
                <p className="mt-3 leading-7 text-green-700">
                  ...
                  I'll personally prepare your complimentary
      ...
      <section className="bg-stone-50 py-24">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <h2 className="text-4xl font-bold">
            Why Request A Home Value From Me?
          </h2>

          <p className="mt-8 text-lg leading-8 text-muted-foreground">
            Online estimates can be useful as a starting point, but they often
            miss the unique features, upgrades, location, and condition that
            influence a home's true market value.
          </p>
