...
const areas = [
  {
    ...
    text:
      "A vibrant area known for restaurants, galleries, nightlife, shopping, events, and a more walkable urban atmosphere.",
  },
  {
    ...
    <main className="bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24">
          <div className="mx-auto max-w-4xl text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.35em] text-orange-500">SCOTTSDALE, ARIZONA</p>
            <h1 className="mt-6 text-5xl font-bold leading-tight md:text-6xl">Discover Scottsdale</h1>
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              ...
              <Link href="/contact"><Button size="lg" variant="outline" className="px-8">Talk With Me</Button></Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-8 text-lg leading-8 text-muted-foreground">
              Scottsdale can feel very different depending on where you live.
              Some buyers are drawn to restaurants, entertainment, and a more
              walkable environment. Others want golf, desert scenery, larger
              properties, or a quieter neighborhood. The right choice starts
              with understanding how you want to live.
            </p>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-8 text-lg leading-8 text-muted-foreground">
            If you're relocating to Scottsdale, I'll help you compare the
            different parts of the city before you spend your time touring
            individual homes. Your priorities can point us toward very
      ...
      <section className="border-t bg-stone-50 py-20">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-muted-foreground">
            Phoenix and other nearby communities may offer a different fit
            depending on your lifestyle, commute, budget, and long-term plans.
          </p>
