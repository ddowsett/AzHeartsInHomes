...
const areas = [
  { title: "Central Phoenix", text: "A mix of established neighborhoods, historic homes, restaurants, cultural attractions, and convenient access to downtown and surrounding areas." },
  { title: "North Phoenix", text: "A diverse area ranging from established neighborhoods to newer developments, with access to shopping, recreation, desert trails, and major transportation routes." },
  { title: "Northeast Phoenix", text: "Desert surroundings, mountain views, established neighborhoods, and convenient access to Scottsdale, Paradise Valley, and the greater Valley." },
  { title: "West Phoenix", text: "A broad collection of established neighborhoods with a variety of housing options and convenient access to West Valley communities." },
];
  ...
  return (
    <main className="bg-background">
      ...
      <section className="relative isolate min-h-[620px] overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10 bg-gradient-to-b from-black/35 via-black/45 to-black/65" aria-hidden="true" />
